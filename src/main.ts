...
function updateCounters() {
    (document.getElementById('user-lives') as HTMLElement).textContent = userLives.toString();
    (document.getElementById('user-wins') as HTMLElement).textContent = userWins.toString();
    (document.getElementById('user-losses') as HTMLElement).textContent = userLosses.toString();
    (document.getElementById('rival-lives') as HTMLElement).textContent = rivalLives.toString();
    (document.getElementById('rival-wins') as HTMLElement).textContent = rivalWins.toString();
    (document.getElementById('rival-losses') as HTMLElement).textContent = rivalLosses.toString();
}
